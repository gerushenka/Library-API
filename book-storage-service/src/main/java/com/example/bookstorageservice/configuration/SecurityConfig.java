...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.oauth2ResourceServer(oauth2Configurer -> oauth2Configurer.jwt(
                ...
                .authorizeHttpRequests(authManager -> authManager
                        ...
                        .requestMatchers(HttpMethod.POST, "/library/book").hasRole("MANAGER")
                        .requestMatchers(HttpMethod.DELETE, "/library/book/**").hasRole("MANAGER")
                        .requestMatchers(HttpMethod.PUT, "/library/book/**").hasRole("MANAGER")
    ...
    public JwtDecoder jwtDecoder() {
        return NimbusJwtDecoder.withJwkSetUri("http://keycloak:8080/realms/users/protocol/openid-connect/certs").build();
    }
}
